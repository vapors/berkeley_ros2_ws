# Interfaces, Switches, and Parameters — v2.5
...
capture audit root: ~/.ros/bhl_standing_pose_capture_audits
evaluation root:    ~/berkeley_ros2_ws/track2_standing_reports
```
