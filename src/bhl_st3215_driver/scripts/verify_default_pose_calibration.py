...
from calibration_common import STEPS_PER_RADIAN, load_servo_map, sha256_file
...
def default_map_path() -> Path:
    return Path(get_package_share_directory("bhl_st3215_driver")) / "config" / "servo_map.yaml"
