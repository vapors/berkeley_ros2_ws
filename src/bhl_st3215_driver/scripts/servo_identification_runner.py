#!/usr/bin/env python3
"""Guarded one-joint identification runner for Berkeley Humanoid Lite.
...
- graph guard refuses a running Berkeley policy node or competing command publisher;
...
class IdentificationNode(Node):
    ...
    def graph_guard(self) -> Tuple[bool, str, Dict[str, object]]:
        ...
        policy_nodes = [n for n in nodes if n.endswith('/berkeley_biped_node')]
...
def write_summary(
    *,
    ...
    lines = [
        'Berkeley Humanoid Lite — Servo Identification Summary',
        '=' * 56,
...
def build_arg_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description='Guarded one-joint ST3215 identification runner for Berkeley Humanoid Lite.'
    )
...
def main() -> int:
    ...
    try:
        print('\nBerkeley Humanoid Lite — guarded servo identification')
        print('=' * 62)
        ...
        print('  Berkeley policy process stopped/disconnected')
